...
public sealed class BatchedTransactionMetadata : TransactionParams
{
    ...
    /// <summary>
    /// Optional explicit endorsement that must be be applied to the outer transaction batch
    ...
    /// </summary>
    /// <remarks>
    /// This will override the the optional endorsement specified in the <see cref="BatchedTransactionParams"/>.
    /// </remarks>
