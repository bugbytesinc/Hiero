...
namespace Hiero;
public sealed class SystemDeleteContractParams : TransactionParams, INetworkParams
{
    /// <summary>
    ...
    string INetworkParams.OperationDescription => "System Delete Contract";
}
...
public static class SystemDeleteContractExtensions
{
    ...
    /// The parameters for the system delete operation, including the contract address to delete.
    /// </param>
