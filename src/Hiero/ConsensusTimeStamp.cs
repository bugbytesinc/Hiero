...
public readonly record struct ConsensusTimeStamp : IComparable<ConsensusTimeStamp>, IComparable
{
    ...
    /// time than the other timestamp, zero if the same and
    ...
    /// <summary>
    /// Compares the current consensus time instance with another
    /// object that may be a consensus time instance.
    /// </summary>
    /// <param name="obj">
    ...
    /// </param>
    /// <returns>
    /// True if the lhs value represents an earlier
    ...
    /// </param>
    /// <returns>
    /// True if the lhs value comes after the rhs value,
    /// otherwise false.
    /// </returns>
    public static bool operator >(ConsensusTimeStamp lhs, ConsensusTimeStamp rhs) => lhs.Seconds > rhs.Seconds;
    /// <summary>
    /// Compares the two consensus time stamps, returns true if the t1
    /// value is equal to or later in time than the t2 value.
    /// </summary>
    /// <param name="t1">
    /// The Consensus Time Stamp Left hand side of the operator.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// True if the t1 value equals or comes after the t2
